    ...
    public static class Orbwalking
    {
        ...
        public class Orbwalker
        {
            ...
            public Orbwalker(Menu attachToMenu)
            {
                ...
                _config.AddItem(
                    new MenuItem("GankingComboMode", "GankingComboMode").SetShared().SetValue(new KeyBind('T', KeyBindType.Press)));

                _config.AddItem(
    new MenuItem("HotKey", "HotKey").SetShared().SetValue(new KeyBind('G', KeyBindType.Press)));
            ...
            public OrbwalkingMode ActiveMode
            {
                get
                {
                    ...
                    if (_config.Item("GankingComboMode").GetValue<KeyBind>().Active)
                    {
                        return OrbwalkingMode.GankingComboMode;
                    }

                    if (_config.Item("HotKey").GetValue<KeyBind>().Active)
                    {
                        return OrbwalkingMode.HotKey;
                    }
